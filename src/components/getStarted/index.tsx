...
export default memo(async function GetStarted() {
  ...
  return (
    <Link href={docUrl} className="text-xl no-underline transition-all hover:underline">
      <button className="group inline-flex min-w-0 cursor-pointer items-center rounded-lg bg-linear-to-r from-[#9e58e9] to-blue-500 px-4 py-[9px] text-sm font-semibold text-white transition-all active:scale-95 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none dark:bg-white/5">
        Get started
        <svg
